...
public class Board {
	...
	*/ 
    ...
    /**
	* Prints the actual configuation of the board.
        * It uses printTopOfBoard() and printBottomOfBoard() to create the strings for the top and bottom of the board respectively.
	*/ 
	...
	*/
    ...
    public boolean checkForBearOff(){
        //Michael
        return true;
    }
}